...
Publicação: pushes em `main` executam o build e enviam somente `dist/` ao GitHub Pages. O Pages oferece os recursos locais; recursos de IA online continuam exigindo o servidor e sua configuração. A composição inclui os textos editoriais nas extremidades, composer inicial entre 140 e 160px e conversa ampla com mensagens do agente à esquerda (até 60%) e do usuário à direita (até 50%) no desktop.
...
O menu mostra Identidade da marca, Configurações, Modelos, Favoritos e Calendário. As outras rotas continuam registradas. Conversas recentes e Nova conversa ficam na lateral recolh?vel. O fundo usa palha quase branco (#faf8f5), e o t?tulo n?o possui efeito de hover. O seletor visual reutiliza todas as opções e eventos do seletor original. Ao digitar, o editor fica compacto na parte inferior; Enter envia e Shift+Enter insere uma quebra de linha. As animações respeitam a preferência de movimento reduzido.
