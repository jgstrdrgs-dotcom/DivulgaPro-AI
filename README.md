...
O menu mostra Identidade da marca, Configurações, Modelos, Favoritos e Calendário. As outras rotas continuam registradas. Conversas recentes e Nova conversa ficam no card junto ao editor. O seletor visual reutiliza todas as opções e eventos do seletor original. Ao digitar, o editor fica compacto na parte inferior; Enter envia e Shift+Enter insere uma quebra de linha. As animações respeitam a preferência de movimento reduzido.
